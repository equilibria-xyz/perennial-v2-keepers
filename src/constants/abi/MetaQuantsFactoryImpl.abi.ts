export const MetaQuantsFactoryImpl = [
  {
    inputs: [
      {
  ...
  {
    inputs: [],
    name: 'MetaQuantsFactoryInputLengthMismatchError',
    type: 'error',
  },
  {
    inputs: [],
    name: 'MetaQuantsFactoryInvalidIdError',
    type: 'error',
  },
  {
    inputs: [],
    name: 'MetaQuantsFactoryInvalidSignatureError',
    type: 'error',
  },
  {
    inputs: [
